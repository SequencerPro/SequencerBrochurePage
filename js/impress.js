...
(function (document) {
    ...
    document.addEventListener("impress:init", function (event) {
        ...
        if (toolbar) {
            // Uncomment line below to show autoplay button on impress toolbar.
    ...
    // Uncomment this to show autoplay button on toolbar.
...
(function (document) {
    ...
    var addNavigationControls = function (event) {
        ...
        // IMPORTANT: Change position of toolbar buttons here (through the style bottom and right).
        var prevHtml = '<button id="impress-navigation-ui-prev" title="Previous" ' +
            'class="impress-navigation-ui btn btn-primary" style="position: absolute;bottom: 15px; right: 120px"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-caret-left-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M3.86 8.753l5.482 4.796c.646.566 1.658.106 1.658-.753V3.204a1 1 0 0 0-1.659-.753l-5.48 4.796a1 1 0 0 0 0 1.506z"/></svg></button>';
        ...
        var nextHtml = '<button id="impress-navigation-ui-next" title="Next" ' +
            'class="impress-navigation-ui btn btn-primary my-auto mx-auto" style="position: absolute; bottom: 15px; right: 15px"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-caret-right-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M12.14 8.753l-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/></svg></button>';

        // The buttont that goes to the overview.
        var xButton = '<button type="button" class="btn btn-outline-danger impress-navigation-ui mx-2" style="position: absolute; bottom: 15px; right: 60px" id="impress-navigation-ui-select"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path fill-rule="evenodd" d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></button>';

        var back = '<div class="position-fixed h-100 w-100" id="clickTest" style="z-index: -1;"></div>';

        var exit = makeDomElement(xButton);
        exit.addEventListener('click',
            function () {
                api.goto('overview');
            });

        var backgroundExit = makeDomElement(back);
        backgroundExit.addEventListener('click',
            function () {
                api.goto('overview');
            });
        ...
        triggerEvent( toolbar, 'impress:toolbar:appendChild', { group: 1, element: backgroundExit } );
        triggerEvent(toolbar, 'impress:toolbar:appendChild', { group: 0, element: prev });
        triggerEvent(toolbar, 'impress:toolbar:appendChild', { group: 0, element: exit });
        // Uncomment line below to show dropdown for steps.
